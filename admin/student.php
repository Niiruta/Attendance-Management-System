...
<html lang = "eng">
		...
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/logoo.png" width = "300px" height = "50px"/>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php if($f_student['attendance']== 1) {
									 ?> <span>&#10003</span><?php
							}else{
								?><span>&#10060</span><?php
							}  ?></td>
							<td><a class = "btn btn-danger rstudent_id" name = "<?php echo $f_student['student_id']?>" href = "#" data-toggle = "modal" data-target = "#delete"><span class = "glyphicon glyphicon-trash"></span></a> <a class = "btn btn-warning  estudent_id" name = "<?php echo $f_student['student_id']?>" href = "#" data-toggle = "modal" data-target = "#edit_student"><span class = "glyphicon glyphicon-edit"></span></a><a class = "btn btn-danger attendanceTrue" name = "<?php echo $f_student['student_no']?>" href = "#" data-toggle = "modal" data-target = "#attendance"><span class = "glyphicon glyphicon-ok"></span></a><a class = "btn btn-danger attendanceFalse" name = "<?php echo $f_student['student_no']?>" href = "#" data-toggle = "modal" data-target = "#attendanceflase"><span class = "glyphicon glyphicon-remove"></span></a> </td>
						</tr>
						<?php
							}
						?>
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.attendanceTrue').click(function(){
				$student_id = $(this).attr('name');
					window.location = 'attendance.php?student_id=' + $student_id;
				
			});
			$('.attendanceFalse').click(function(){
				$student_id = $(this).attr('name');
					window.location = 'attendanceFalse.php?student_id=' + $student_id;
